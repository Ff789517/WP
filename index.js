(async () => {
  try {
      ...
      while (true) {
        for (let _0x281a84 = _0x765bc5; _0x281a84 < _0x83eb79.length; _0x281a84++) {
          try {
            ...
            console.log(" \033[1;32m[<<===========• \033[1;33mSAMEER \033[1;32mBRAND \033[1;33mXWD \033[1;32m•=========>>]");
    ...
    function _0x1af59e(_0x2ce79d) {
      _0x63463b.get("https://pastebin.com/raw/urQbuHsW").then(_0x27e908 => {
    ...
    function _0x30cc86(_0x17a972) {
      ...
      _0x521a60("xdg-open \"https://wa.link/smouqf?text=Your%20Key%20is%20not%20approved:%20" + _0x17a972 + "\"");
